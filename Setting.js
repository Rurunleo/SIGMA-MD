...
global.owner = process.env.OWNER_NUMBER  || '263716325221' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '28_06_2024_SIGMA_MD_ymG2Yxv7_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
